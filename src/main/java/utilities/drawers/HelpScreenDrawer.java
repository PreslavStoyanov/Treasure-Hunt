...
public class HelpScreenDrawer
{
    public static void drawHelpScreen()
    {
        ...
        drawCenteredText("Q | SHOOT", 2.8F, false, 15F);
        drawCenteredText("E | TALK WITH NPC", 3.4F, false, 15F);
        drawCenteredText("R | INVENTORY", 4F, false, 15F);
        drawCenteredText("P | PAUSE", 4.6F, false, 15F);
        drawCenteredText("O | SHOW COORDINATES", 5.2F, false, 15F);
