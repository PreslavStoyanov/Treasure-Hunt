...
public class HelpScreenDrawer
{
    public static void drawHelpScreen()
    {
        ...
        drawCenteredText("R | SHOOT", 2.8F, false, 15F);
        drawCenteredText("F | CONCENTRATE", 3.4F, false, 15F);
        drawCenteredText("E | TALK WITH NPC", 4F, false, 15F);
        drawCenteredText("Q | INVENTORY", 4.6F, false, 15F);
        drawCenteredText("P | PAUSE", 5.2F, false, 15F);
        drawCenteredText("O | SHOW COORDINATES", 5.8F, false, 15F);
